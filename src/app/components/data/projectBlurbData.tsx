...
export const projects: ProjectBlurb[] = [
     ...
     },
    {
        ...
        description: "This project focused on using a hybrid control approach to manage slack in the cables while also allowing for dynamic reconfigurations of the quadrotors to maintain a stable formation.",
      ...
      },
    {
      ...
      media: "/media/images/iterativeControl.png",
      tags: ["Iterative Learning Control", "Hybrid Dynamics", "Trajectory Optimization", "Bipedal Walking", "Julia"],
    },
    {
    ...
    },
    {
      ...
      description:"This project developed a decentralized multi-robot frontier exploration algorithm, allowing a team of robots to explore unknown environments by coordinating their efforts and sharing information. The project implemented a modified A* algorithm and used cost maps to aid in exploration.",
       media: "/media/videos/frontier_grid_small.mp4",
      tags: ["Robotics", "Multi-Agent Systems", "Path Planning", "A*", "Python"],
    },
      {
      title: "Symbolic Planner",
      description: "This project involved the development of a symbolic planner, a general-purpose tool designed to solve problems described using symbolic representations.",
    ...
    },
    {
      ...
      description:"This project compared Probabilistic Roadmap (PRM), Rapidly-exploring Random Tree (RRT), RRT-Connect, and RRT* motion planning algorithms based on computational efficiency, path cost, and success rate for robotic systems.",
    ...
    },
    {
      ...
      tags: ["Robotics", "Object Detection", "Path Planning", "Manipulation", "Algorithms", "Python"],
    },
    {
